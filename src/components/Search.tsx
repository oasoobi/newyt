...
export function Search() {
    ...
    return (
        <div className="relative bg-[#ffffff93] h-10 w-[80%] max-w-[35rem] rounded-lg flex items-center justify-center border" onFocus={() => setIsHidden(false)} onBlur={() => setTimeout(() => setIsHidden(true), 150)}>
            <div className="pl-2">
                <svg viewBox="0 0 24 24" width="23" height="23" xmlns="http://www.w3.org/2000/svg" stroke="#000000" strokeWidth="2" fill="none" strokeLinecap="round" stroke-Linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
            </div>
