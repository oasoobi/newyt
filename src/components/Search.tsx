...
export function Search() {
    ...
    return (
        <div className="relative bg-[#ffffff93] h-10 w-[80%] max-w-[35rem] rounded-lg flex items-center justify-center border" onFocus={() => setIsHidden(false)} onBlur={() => setTimeout(() => setIsHidden(true), 150)}>
            <div className="pl-2">
                <svg viewBox="0 0 24 24" width="23" height="23" stroke="#000000" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
            </div>
