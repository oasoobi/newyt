...
export function Channel({ channel }: { channel:  Channel}) {
    return (
        <Link href={"/channel/" + channel.authorId} className="flex border p-3 rounded-md hover:bg-gray-100 w-[80%] mb-5">
            <Image src={"https:" + channel.authorThumbnails[4].url} width={150} height={150} alt="" className="rounded-full"/>
            <div className="ml-4">
            <div className="flex items-center">
                    <h1 className="mr-1">{channel.author}</h1>
