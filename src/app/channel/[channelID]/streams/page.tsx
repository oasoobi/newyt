...
export default function Home() {
  ...
  const channelID = pathname.replace("/channel/", "").replace("/streams", "");
  ...
  return (
    <main className="flex min-h-screen flex-col items-center pl-12 pr-12 mb-10">
      ...
      <div className="mt-[15rem]">
        {
          data && data?.authorBanners.length > 0 ? <Image src={data?.authorBanners[0].url as string} alt="" width={100} height={20} className=""/> :
            <></>
        }
